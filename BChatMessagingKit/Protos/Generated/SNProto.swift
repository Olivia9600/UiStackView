...
@objc public class SNProtoDataMessageBeldexProfile: NSObject {
    ...
    // MARK: - SNProtoDataMessageBeldexProfileBuilder

    @objc public class func builder() -> SNProtoDataMessageBeldexProfileBuilder {
        return SNProtoDataMessageBeldexProfileBuilder()
    }

    // asBuilder() constructs a builder that reflects the proto's contents.
    @objc public func asBuilder() -> SNProtoDataMessageBeldexProfileBuilder {
        let builder = SNProtoDataMessageBeldexProfileBuilder()
    ...
    @objc public class SNProtoDataMessageBeldexProfileBuilder: NSObject {

        private var proto = SessionProtos_DataMessage.BeldexProfile()
        ...
        @objc public func build() throws -> SNProtoDataMessageBeldexProfile {
            return try SNProtoDataMessageBeldexProfile.parseProto(proto)
        }

        @objc public func buildSerializedData() throws -> Data {
            return try SNProtoDataMessageBeldexProfile.parseProto(proto).serializedData()
        }
    }

    fileprivate let proto: SessionProtos_DataMessage.BeldexProfile
    ...
    private init(proto: SessionProtos_DataMessage.BeldexProfile) {
        self.proto = proto
    }
    ...
    @objc public class func parseData(_ serializedData: Data) throws -> SNProtoDataMessageBeldexProfile {
        let proto = try SessionProtos_DataMessage.BeldexProfile(serializedData: serializedData)
        return try parseProto(proto)
    }

    fileprivate class func parseProto(_ proto: SessionProtos_DataMessage.BeldexProfile) throws -> SNProtoDataMessageBeldexProfile {
        // MARK: - Begin Validation Logic for SNProtoDataMessageBeldexProfile -

        // MARK: - End Validation Logic for SNProtoDataMessageBeldexProfile -

        let result = SNProtoDataMessageBeldexProfile(proto: proto)
        return result
    }
...
extension SNProtoDataMessageBeldexProfile {
    @objc public func serializedDataIgnoringErrors() -> Data? {
        return try! self.serializedData()
    }
}

extension SNProtoDataMessageBeldexProfile.SNProtoDataMessageBeldexProfileBuilder {
    @objc public func buildIgnoringErrors() -> SNProtoDataMessageBeldexProfile? {
        return try! self.build()
    }
}
...
// MARK: - SNProtoDataMessagePayment

@objc public class SNProtoDataMessagePayment: NSObject {
    ...
    @objc public class SNProtoDataMessagePaymentBuilder: NSObject {

        private var proto = SessionProtos_DataMessage.Payment()
        ...
        @objc public func build() throws -> SNProtoDataMessagePayment {
            return try SNProtoDataMessagePayment.parseProto(proto)
        }

        @objc public func buildSerializedData() throws -> Data {
            return try SNProtoDataMessagePayment.parseProto(proto).serializedData()
        }
    }

    fileprivate let proto: SessionProtos_DataMessage.Payment
    ...
    @objc public class func parseData(_ serializedData: Data) throws -> SNProtoDataMessagePayment {
        let proto = try SessionProtos_DataMessage.Payment(serializedData: serializedData)
        return try parseProto(proto)
    }

    fileprivate class func parseProto(_ proto: SessionProtos_DataMessage.Payment) throws -> SNProtoDataMessagePayment {
        guard proto.hasAmount else {
            throw SNProtoError.invalidProtobuf(description: "\(logTag) missing required field: amount")
        }
        ...
        // MARK: - End Validation Logic for SNProtoDataMessagePayment -
...
extension SNProtoDataMessagePayment {
    @objc public func serializedDataIgnoringErrors() -> Data? {
        return try! self.serializedData()
    }
}

extension SNProtoDataMessagePayment.SNProtoDataMessagePaymentBuilder {
    @objc public func buildIgnoringErrors() -> SNProtoDataMessagePayment? {
        return try! self.build()
    }
}
...
@objc public class SNProtoDataMessage: NSObject {
    ...
    fileprivate class func parseProto(_ proto: SessionProtos_DataMessage) throws -> SNProtoDataMessage {
        ...
        if proto.hasProfile {
            profile = try SNProtoDataMessageBeldexProfile.parseProto(proto.profile)
        }
