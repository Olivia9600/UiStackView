...
final class NewSecretGroupVC : BaseVC, UITableViewDataSource, UITableViewDelegate, TableViewTouchDelegate, UITextFieldDelegate, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        setNavBarTitle(NSLocalizedString("New Secret Group", comment: ""), customFontSize: customTitleFontSize)
