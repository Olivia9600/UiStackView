...
#import <BChatUtilitiesKit/NSUserDefaults+OWS.h>
...
#import <BChatUtilitiesKit/OWSMath.h>
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // OWSLinkPreview is now in BChatMessagingKit, so to still be able to deserialize them we
    // need to tell NSKeyedUnarchiver about the changes.
    [NSKeyedUnarchiver setClass:OWSLinkPreview.class forClassName:@"BChatServiceKit.OWSLinkPreview"];
...
- (void)applicationDidBecomeActive:(UIApplication *)application {
    ...
    NSUserDefaults *sharedUserDefaults = [[NSUserDefaults alloc] initWithSuiteName:@"group.com.beldex.bchat"];
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (lastProfilePictureUpload != nil && [now timeIntervalSinceDate:lastProfilePictureUpload] > 14 * 24 * 60 * 60) {
                ...
                [profileManager updateLocalProfileName:name avatarImage:profilePicture success:^{
                    // Do nothing; the user defaults flag is updated in BeldexFileServerAPI
...
- (BOOL)application:(UIApplication *)app openURL:(NSURL *)url options:(NSDictionary<UIApplicationOpenURLOptionsKey, id> *)options
{
    ...
    // URL Scheme is bchatmessenger://DM?bchatID=1234
